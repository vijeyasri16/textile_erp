  ...
  return (
    <Flex height="100vh" direction="column" position="relative">
      ...
      {isOpen && (
        <Box position="fixed" top={0} left={0} width="250px" height="100vh" bg="gray.100" p={4} zIndex={20}>
          <VStack spacing={4} align="stretch">
            <Link href="/collection/collection-voucher" passHref>
              <Button width="full" colorScheme="blue" justifyContent="flex-start" textAlign="left">Collection Voucher</Button>
            </Link>
      ...
      <Flex flex={1} align="center" justify="center" bg="gray.50" height="100vh">
        <Heading size="2xl" color="gray.700">Collection Section</Heading>
      </Flex>
    </Flex>
  );
}
