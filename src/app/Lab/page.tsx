  ...
  return (
    <Flex height="100vh" direction="column" position="relative">
      ...
      {isOpen && (
        <Box position="fixed" top={0} left={0} width="250px" height="100vh" bg="gray.100" p={4} zIndex={20}>
          <VStack spacing={4} align="stretch">
            <Link href="/Lab/dyeing&planning" passHref>
              <Button width="full" colorScheme="blue" justifyContent="flex-start" textAlign="left">Dyeing & Planning</Button>
            </Link>
            <Link href="/Lab/lab-entry" passHref>
              <Button width="full" colorScheme="blue" justifyContent="flex-start" textAlign="left">Lab Entry</Button>
            </Link>
      ...
      <Flex flex={1} align="center" justify="center" bg="gray.50" height="100vh">
        <Heading size="2xl" color="gray.700">Lab Section</Heading>
      </Flex>
    </Flex>
  );
}
