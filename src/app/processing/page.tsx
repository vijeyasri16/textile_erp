  ...
  return (
    <Flex height="100vh" direction="column" position="relative">
      ...
      {isOpen && (
        <Box position="fixed" top={0} left={0} width="250px" height="100vh" bg="gray.100" p={4} zIndex={20}>
          <VStack spacing={4} align="stretch">
            <Link href="/processing/delivery" passHref>
              <Button width="full" colorScheme="blue" justifyContent="flex-start" textAlign="left">Delivery</Button>
            </Link>
            <Link href="/processing/goods-inward" passHref>
              <Button width="full" colorScheme="blue" justifyContent="flex-start" textAlign="left">Goods Inward</Button>
            </Link>
            <Link href="/processing/delivery-receipt" passHref>
              <Button width="full" colorScheme="blue" justifyContent="flex-start" textAlign="left">Delivery Receipt</Button>
            </Link>
            <Link href="/processing/invoice" passHref>
              <Button width="full" colorScheme="blue" justifyContent="flex-start" textAlign="left">Invoice</Button>
            </Link>
      ...
      <Flex flex={1} align="center" justify="center" bg="gray.50" height="100vh">
        <Heading size="2xl" color="gray.700">Processing Section</Heading>
      </Flex>
    </Flex>
  );
}
