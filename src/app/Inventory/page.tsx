      ...
      {isOpen && (
        <Box position="fixed" top={0} left={0} width="250px" height="100vh" bg="gray.100" p={4} zIndex={20}>
          <VStack spacing={4} align="stretch">
            <Link href="/Inventory/addraw" passHref>
              <Button width="full" colorScheme="blue" justifyContent="flex-start" textAlign="left">Add Raw Materials</Button>
            </Link>
            <Link href="/Inventory/viewraw" passHref>
              <Button width="full" colorScheme="blue" justifyContent="flex-start" textAlign="left">View Raw Materials</Button>
            </Link>
            <Link href="/Inventory/editraw" passHref>
              <Button width="full" colorScheme="blue" justifyContent="flex-start" textAlign="left">Edit Raw Materials</Button>
            </Link>
